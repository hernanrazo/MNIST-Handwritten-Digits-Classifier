package hernanrazo.handwriting.views;
...
public class DrawModel {
    ...
    public static class Line {
        ...
        private void addElem(LineElem elem) {elems.add(elem);}
        public int getElemSize() {return elems.size();}
        public LineElem getElem(int index) {return elems.get(index);}
    }
